...
#Calcualte the range of the spatial autocorrelation 
...
# Assign Moran's I result to varaible to calculated z value 
mI <- mi$estimate[[1]]
eI <- mi$estimate[[2]]
var <- mi$estimate[[3]]
...
png("LISA Moran Plot Queen's Case Height.png")
